// UploadImageDialogComponent onAddUploadedImage={this.handleAddUploadedImage} onCancelUploadedImage={this.handleHideUploadImageDialog}
...
export interface UploadImageDialogComponentProps {
  ...
  onAddUploadedImage: (title: string, imageUrl:string) => void
...
export class UploadImageDialogComponent extends React.Component<UploadImageDialogComponentProps, UploadImageDialogComponentState> {
  ...
  handleAddToCollaborationSpaceButton = () => {
    ...
    if (imageUploadUrl) {
      this.props.onAddUploadedImage(name, imageUploadUrl)
    }
  }
  ...
  renderBeforeUploadForm() {
    ...
    return (
      <div>
        ...
        <div>
          <strong>Remember:</strong> do <u>not</u> upload personally identifiable information.
        </div>
      </div>
    )
  }
  ...
  renderAfterUploadForm() {
    ...
    return (
      <div>
        ...
        <div>
          <button type="button" onClick={this.handleAddToCollaborationSpaceButton} disabled={addButtonDisabled}>Add to Collaboration Space</button>
